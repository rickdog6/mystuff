...
password = 'Crotalus13'            #this is your gmail password
IP_WEBSITE = "http://myip.xname.org"   #this is the url i am using to get the public IP

spreadsheet_key = '0AmoSLvVqU5mvdE5UcDdyVnA2TUJNakl4UTBnbV9MdHc' # Find this value in the spreadsheet url with 'key=XXX' and copy XXX below
...
def temp(): #gets uptime load average etc could split it out easily if needed it is comma seperated
...
def main():
   ...
   dict['datetime'] = time.strftime('%D %T')
