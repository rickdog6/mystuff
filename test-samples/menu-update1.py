...
if __name__ == '__main__':
    ...
    file_list = ['index.html',
    		 'reader.html',
                 ...
                 'checklists/issuecheck.html',
                 'performance/activity.html',
                 'performance/spike-data.html',
                 'performance/spikes.html',
                 'testdocs/gammaspecdoc.html',
                 'testdocs/pedangletest.html']
